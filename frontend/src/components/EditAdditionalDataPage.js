  ...
  return (
    <div className="additional-data-page">
      <header className="adp-header">
        ...
        <button className="adp-close-button" onClick={() => navigate('/objection-data-storage')}>
      ...
      <div className="ad-footer">
        <button className="ad-submit-button" onClick={handleSubmit} disabled={!file}>수정하기</button>
      </div>
    </div>
  );
};
