...
const EditObjectionForm = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    email: 'shlee5820@hanyang.ac.kr',
    address: '세종특별자치시 절재로 13 (아름동, 범지기마을1단지)',
    bankName: '인터넷은행A',
    storeName: '입출금통장',
    titleHolder: '이승환',
    accountNumber: '11011122223333',
    objectionReason: '나는 범죄자가 아닙니다!',
    objectionAgreed: true,
  });
  ...
  return (
    <div className="app-container">
      <div className="of-header">
        ...
        <button className="close-button" onClick={() => navigate('/objection-data-storage')}>
